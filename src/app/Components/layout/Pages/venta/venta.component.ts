...
export class VentaComponent implements OnInit{
  ...
  // Método para retornar productos por filtro
  ...
  constructor(
    ...
    // Crear el formulario de venta de productos
    this.formularioProductoVenta = this.fb.group({
      producto: ['', Validators.required],
      cantidad: ['', Validators.required]
    });

    // Obtener la lista de productos activos con stock disponible
    ...
    // Suscribirse a los cambios en el campo de búsqueda de productos
  ...
  // Método para seleccionar un producto para la venta
  productoParaVenta(event: any){
    this.productoSeleccionado = event.option.value;
  }

  // Método para agregar un producto a la lista de productos para la venta
  ...
  // Método para eliminar un producto de la lista de productos para la venta
